from .Pano_visualization import R_roll, R_pitch
from scipy.ndimage.interpolation import map_coordinates
import numpy as np
from PIL import Image
import skimage.io
import os
from .Pano_consensus_vis import calculate_zenith_point_coordinate, calculate_horizon_coordinates, calculate_hvps
...
def save_heading_only(point1, im, m, n):
    ...
    # angle_x = np.degrees(np.arctan2(point1[:, 0], point1[:, 2]))
    angle_x = np.arctan2(point1[:, 0], point1[:, 2]) # rad
