import numpy as np
from histograms import mnf_modes
...
def vp_score(vp_homo, lines_homo, score_function):
    ...
    # Non convertiamo horgroup in array NumPy perché contiene elementi di lunghezza variabile
    # horgroup rimane come lista di array
...
def vp_predict(lines_homo, initialIds, horizon_homo, params):
    ...
    if len(max_modes) == 0:
        ...
        # Uso della lista comprehension per riordinare una lista usando gli indici
